    ...
    const modalConfig = useMemo<{
        ...
        if (twoFactorEnabled) {
            return {
                ...
                description:
                    'La autenticación en dos pasos ya está activada. Escanea el código QR o ingresa la clave en tu aplicación autenticadora.',
                buttonText: 'Cerrar',
            };
        }
        ...
        return {
            ...
            description:
                'Para terminar de activar la autenticación en dos pasos, escanea el código QR o ingresa la clave en tu aplicación autenticadora',
            buttonText: 'Continuar',
        };
